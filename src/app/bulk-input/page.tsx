      ...
      <div className="space-y-6">
        ...
        <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
          ...
          <div className="flex items-center gap-3">
            <button
              onClick={handleReset}
              className="flex items-center gap-2 px-4 py-2 rounded-xl bg-white/10 text-muted-foreground hover:bg-white/20 transition-colors"
            >
              <RotateCcw size={16} />
              リセット
            </button>
            <button
              ...
              className={`flex items-center gap-2 px-5 py-2.5 rounded-xl font-medium transition-all ${
                changedCount > 0
                  ...
                  : 'bg-white/20 text-muted-foreground cursor-not-allowed'
              }`}
            >
              {isSaving ? (
                    ...
                    >
                      ...
                      <td className="px-4 py-3">
                        <input
                          ...
                          className="w-24 mx-auto block px-3 py-1.5 bg-[oklch(0.18_0_0)] border border-white/10 rounded-lg text-white text-center text-sm focus:outline-none focus:border-white/30 placeholder:text-muted-foreground"
                        />
                      </td>
                      <td className="px-4 py-3 text-center text-muted-foreground text-sm tabular-nums">
