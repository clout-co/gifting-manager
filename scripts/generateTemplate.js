...
function generateTemplate() {
  ...
  const rulesData = [
    ...
    ['枚数', '任意', '数値', '商品の数量（未入力時は1）', '1'],
    ['セール日', '推奨', '日付', '商品のセール開始日（YYYY-MM-DD形式）', '2024-03-01'],
    ...
    ['投稿日', '任意', '日付', '実際の投稿日', '2024-03-14'],
    ['投稿URL', '任意', 'URL', '投稿のURL', 'https://instagram.com/p/xxxxx'],
    ['いいね数', '任意', '数値', '投稿のいいね数', '1500'],
    ['コメント数', '任意', '数値', '投稿のコメント数', '50'],
    ['回数', '任意', '数値', '案件の実施回数（未入力時は1）', '1'],
    ['備考', '任意', 'テキスト', '自由記述のメモ', '特記事項など'],
    [''],
